  ...
  >
    <ProfileMenu
      ...
      containerClassName={clsm([
        ...
        'max-h-[min(634px,calc(calc(var(--mobile-vh,1vh)_*_100)_-_32px))]', // Desktop max-height calculation
        'md:landscape:max-h-[570px]', // Fallback
        'md:landscape:max-h-[min(570px,calc(calc(var(--mobile-vh,1vh)_*_100)_-_32px))]', // Mobile (portrait) max-height calculation
